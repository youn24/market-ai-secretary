...
# ─────────────────────────────────────────────────────────────────────────────
# 円買い介入（円安を止める介入）の実績。
# 出典: 財務省「外国為替平衡操作の実施状況」公式CSV（src/intervention_stats.py が随時取得）
# ※水準はその日のドル円終値、金額はその年の合計
_INTERVENTION_HISTORY = [
    {"date": "2022年9月",  "level": 144.32, "note": "22年ぶりの円買い介入（2.8兆円）"},
    {"date": "2022年10月", "level": 150.18, "note": "大規模2回（10月計 6.3兆円）"},
    {"date": "2024年4〜5月", "level": 158.22, "note": "34年ぶり円安局面（4〜5月計 9.8兆円）"},
    {"date": "2024年7月",  "level": 161.61, "note": "161円台で2回（7月計 5.5兆円）"},
    {"date": "2026年4月",  "level": 160.18, "note": "1日で過去最大 6.28兆円"},
    {"date": "2026年5月",  "level": 157.68, "note": "追撃介入2回（5月計 5.5兆円）"},
]
