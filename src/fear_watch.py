...
較正（2026-09-10・実際の判定コードを843営業日の履歴に流して実測）:
  入る＝上位5% ／ 出る＝上位25%より下 ／ 急騰＝前日比+25%
  → 異常水準に入った 年3.2回・落ち着いた 年3.2回・急騰 年5.5回
  → **合計 年11.9回**。プロジェクトの基準「年5〜15回」の範囲内。
  （詳しい経緯と、最初の見積りが5倍外れた理由は下の _ENTER_PCT の注記）

ゾーンの「出入り」で判定する理由:
  水準そのもので毎回鳴らすと、高い水準が続く週は毎日鳴って読まれなくなる。
  行動が変わるのは「入った日」と「出た日」だけなので、そこだけ知らせる。
  出た日＝「落ち着きました」も、待つべきか動くべきかの判断に必要なので送る。
  入る線と出る線を分けている（ヒステリシス）のは、境界の上下で
  毎日「入った」「出た」と鳴るのを防ぐため。
