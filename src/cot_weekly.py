...
def build_message(items: list, report_date: str = "") -> str:
    ...
    # ⚠️ 「やや買い方向」と「ネット売り越し」が同じ行に並ぶことがある（S&P500など）。
    #    方向は符号ではなく「その市場の過去3年と比べた傾き」なので正しいが、
    #    説明が無いと初心者には矛盾に見える（2026-09-11の点検で指摘）。
    lines.append("\n※「〜方向」は買い越し・売り越しの向きではなく、"
                 "*その市場の過去3年と比べてどちらに傾いているか*です。"
                 "たとえばS&P500は投機筋がいつも売り越し（ヘッジ）なので、"
                 "「売り越しでも、いつもより売りが少ない」ときは「買い方向」になります。")
    lines.append("※投機筋＝ヘッジファンド等（Leveraged Money）の建玉。"
